package com.elementary.core.service.Impl;

import com.elementary.core.service.RedisService;
...
public class RedisServiceImpl implements RedisService {
    ...
    public Integer increaseIntegerValue(String key, int increment) {
        Long newValue = stringRedisTemplate.opsForValue().increment(key, increment);
        if (newValue == null) {
            return null;
        } else {
    ...
    public Integer decreaseIntegerValue(String key, int decrement) {
        String oldValue = stringRedisTemplate.opsForValue().get(key);
        stringRedisTemplate.opsForValue().increment(key, -decrement);
        if (oldValue == null) {
            return null;
        } else {
            return Integer.valueOf(oldValue);
